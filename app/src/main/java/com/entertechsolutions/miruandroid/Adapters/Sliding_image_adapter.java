...
public class Sliding_image_adapter  extends PagerAdapter {
        ...
        public Sliding_image_adapter(Context context, ArrayList<image_Model> imageModelArrayList) {
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            View imageLayout = inflater.inflate(R.layout.slideing_image_layout, view, false);
